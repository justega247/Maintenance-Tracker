...
const usersTableSeed = `INSERT INTO users(username,fullname,email,password,role)(VALUES('johnson','Holmes','me@you','${testPassword}','admin'));`;
...
const requestsTableSeed = "INSERT INTO requests(user_id,title,description,status)(VALUES(1,'BROKEN CHAIR','THE CHAIR IS BROKEN','approved'));";
