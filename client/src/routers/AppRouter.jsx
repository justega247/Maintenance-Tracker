...
import AdminRequestDetailsPage from "../components/AdminRequestDetails";
  ...
  <BrowserRouter>
    <div>
      ...
      <Switch>
        ...
        <PrivateRoute
          exact
          path={frontendRoutes.ADMIN_DASHBOARD}
          component={AdminRequestPage}
        />
        <PrivateRoute
          exact
          path={frontendRoutes.USER_DASHBOARD}
          component={UserRequestPage}
        />
        <PrivateRoute
          exact
          path={frontendRoutes.CREATE_REQUEST}
          component={CreateRequestPage}
        />
        <PrivateRoute
          exact
          path={frontendRoutes.VIEW_REQUEST}
          component={RequestDetailsPage}
        />
        <PrivateRoute
          exact
          path={frontendRoutes.ADMIN_VIEW_REQUEST}
          component={AdminRequestDetailsPage}
        />
        <PrivateRoute
          exact
          path={frontendRoutes.EDIT_REQUEST}
